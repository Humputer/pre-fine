...
class Model(nn.Module):
    def __init__(self, args):
        ...
        pretrained_tweet_embedding = torch.load('../dataset/'+args.dataset+'/tweet_embedding_m.pt')
        ...
        pretrained_description_embedding = torch.load('../dataset/'+args.dataset+'/node_features_m.pt')
